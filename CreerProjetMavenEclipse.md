...
## Votre premier pom (à garder sous la main)

Supprimer tout ce que contient actuellement votre `pom.xml`
et copiez-collez y le contenu suivant :  
...
*Et maintenant, place aux explications afin que vous compreniez mieux à quoi correspond les lignes de code que vous venez de copier-coller dans votre `pom.xml` et qui permettent d'effectuer quelques premières configurations sur votre projet maven.* 
